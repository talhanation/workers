...
public class MessageMerchantTradeButton implements Message<MessageMerchantTradeButton> {
    ...
    public void executeServerSide(NetworkEvent.Context context) {
        ...
        List<MerchantEntity> list = Objects.requireNonNull(context.getSender()).getCommandSenderWorld().getEntitiesOfClass(MerchantEntity.class, context.getSender().getBoundingBox().inflate(100.0D));
