...
public class SwineherdVillagerRenderer extends AbstractWorkersVillagerRenderer {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID,"textures/entity/villager/swineherd.png"),
    };

    public SwineherdVillagerRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
