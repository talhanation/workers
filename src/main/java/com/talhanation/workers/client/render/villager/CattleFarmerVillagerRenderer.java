...
public class CattleFarmerVillagerRenderer extends AbstractWorkersVillagerRenderer {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID,"textures/entity/villager/cattle_farmer.png"),
    };

    public CattleFarmerVillagerRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
