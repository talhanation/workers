...
public class WorkersVillagerProfessionLayer extends RenderLayer<AbstractRecruitEntity, HumanoidModel<AbstractRecruitEntity>> {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(WorkersMain.MOD_ID,"textures/entity/villager/villager_miner_cloth.png"),
            new ResourceLocation(WorkersMain.MOD_ID,"textures/entity/villager/villager_farmer_cloth.png"),
            new ResourceLocation(WorkersMain.MOD_ID,"textures/entity/villager/villager_fisherman_cloth.png"),
            new ResourceLocation(WorkersMain.MOD_ID,"textures/entity/villager/villager_animalfarmer_cloth.png"),
