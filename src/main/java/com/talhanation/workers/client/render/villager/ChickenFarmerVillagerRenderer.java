...
public class ChickenFarmerVillagerRenderer extends AbstractWorkersVillagerRenderer {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID,"textures/entity/villager/chicken_farmer.png"),
    };

    public ChickenFarmerVillagerRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
