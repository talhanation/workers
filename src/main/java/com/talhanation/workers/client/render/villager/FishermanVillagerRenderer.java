...
public class FishermanVillagerRenderer extends AbstractWorkersVillagerRenderer {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID, "textures/entity/villager/fisherman.png"),
    };

    public FishermanVillagerRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
