...
public class WorkersBipedRenderer<E extends CreatureEntity, M extends BipedModel<E>> extends BipedRenderer<E, M>{

    public static final float PLAYER_SCALE = 0.9375F;

    protected static final float BIPED_SHADOW_SIZE = 0.5F;

    public WorkersBipedRenderer(EntityRendererManager manager, M model, M leggingsModel, M mainArmorModel, float shadowSize) {
