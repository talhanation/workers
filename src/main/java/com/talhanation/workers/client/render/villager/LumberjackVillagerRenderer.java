...
public class LumberjackVillagerRenderer extends AbstractWorkersVillagerRenderer {

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID, "textures/entity/villager/lumberjack.png"),
    };

    public LumberjackVillagerRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
