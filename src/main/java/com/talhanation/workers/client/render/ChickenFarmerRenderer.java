...
public class ChickenFarmerRenderer extends AbstractWorkersRenderer<AbstractWorkerEntity>{

    private static final ResourceLocation[] TEXTURE = {
            new ResourceLocation(Main.MOD_ID,"textures/entity/chicken_farmer.png"),
    };

    public ChickenFarmerRenderer(EntityRendererProvider.Context mgr) {
        super(mgr);
    }
