...
public class BowmanEntity extends AbstractWorkerEntity implements IRangedAttackMob {

    public BowmanEntity(EntityType<? extends AbstractWorkerEntity> entityType, World world) {
