...
public class CrossBowmanEntity extends AbstractWorkerEntity implements ICrossbowUser{
    ...
    public CrossBowmanEntity(EntityType<? extends AbstractWorkerEntity> entityType, World world) {
